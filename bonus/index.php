	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light ">
		<div class="container">
			<a class="navbar-brand" href="#">
				<img src="pertanian.png" width="30" height="30" alt="">
			SMKN PERTANIAN TERPADU PROVINSI RIAU</a>
		...
		<div class="container" style="margin-top:20px" >
			...
			<h4>Daftar Nama Siswa SMKN Pertanian Terpadu Provinsi Riau</h4>
			</nav>
		<hr>
		...
		<table class="table table-striped table-hover table-sm table-bordered">
			...
			<p>ANGGUN DINDA PUTRI MILENIA</p>
				<footer class="blockquote-footer">TIF 2B</footer>
			</blockquote>
