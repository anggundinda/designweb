...
<html>
<head>
	<title>SMKN PERTANIAN TERPADU PROVINSI RIAU</title>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					...
					<img src="pertanian.png" width="45" height="45" alt="">
				</ul>
			</div>
		</div>
	</nav>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="jurusan" class="form-control" required>
							...
							<option value="AGRIBISNIS TANAMAN PERKEBUNAN (ATP)">AGRIBISNIS TANAMAN PERKEBUNAN (ATP)</option>
							<option value="AGRIBISNIS TANAMAN PANGAN DAN HORTIKULTURA">AGRIBISNIS TANAMAN PANGAN DAN HORTIKULTURA (ATPH)</option>
							<option value="AGRO INDUSTRI">AGRO INDUSTRI (AI)</option>
							<option value="AGRIBISNIS PERBENIHAN & KULTUR JARINGAN ">AGRIBISNIS PERBENIHAN & KULTUR JARINGAN (APKJ)</option>
						</select>
					</div>
				</div>
				<div class="form-group row">
